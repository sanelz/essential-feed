...
public final class FeedViewController: UITableViewController, UITableViewDataSourcePrefetching {
    ...
    private var cellControllers = [IndexPath: FeedImageViewCellController]()
    ...
    private func cellController(forRowAt indexPath: IndexPath) -> FeedImageViewCellController {
        ...
        let cellController = FeedImageViewCellController(model: cellModel, imageLoader: imageLoader!)
