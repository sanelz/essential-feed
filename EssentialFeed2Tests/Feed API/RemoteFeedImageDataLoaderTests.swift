...
class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_deliversInvalidDataError200HTTPResponseWithEmptyData() {
        let (sut, client) = makeSUT()
    ...
    func test_loadImageDataFromURL_doesNotDeliverResultAfterCancellingTask() {
        ...
        XCTAssertTrue(received.isEmpty, "Expected no recived results after cancelling task")
    }
